...
DROP FUNCTION IF EXISTS fn_treat_batch(UUID, INTEGER, JSONB, batch_quality, INTEGER, TEXT);

CREATE FUNCTION fn_treat_batch(
  p_input_batch_id UUID,
...
GRANT EXECUTE ON FUNCTION fn_treat_batch(UUID, NUMERIC, JSONB, batch_quality, NUMERIC, TEXT) TO authenticated;
