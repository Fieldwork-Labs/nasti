...
import { type ScoutingNotePhotoSignedUrl } from "@/hooks/useScoutingNotePhotos"

type PhotoCardProps = {
  photo: ScoutingNotePhotoSignedUrl
  onDelete?: (id: string) => Promise<string>
  onUpdateCaption?: (id: string, caption: string) => Promise<ScoutingNotePhoto>
  onClickPhoto?: (photo: ScoutingNotePhotoSignedUrl) => void
}

export const ScoutingNotePhotoCard = ({
  photo,
  onDelete,
  onUpdateCaption,
  onClickPhoto,
