...
import { useScoutingNotePhotos } from "@/hooks/useScoutingNotePhotos"
import { Spinner } from "@nasti/ui/spinner"
import { ScoutingNotePhotoCard } from "./ScoutingNotePhotoCard"

type ScoutingNotePhotoUploadProps = { scoutingNoteId?: string }

export const ScoutingNotePhotoUpload = ({
  scoutingNoteId,
}: ScoutingNotePhotoUploadProps) => {
  const {
    photos,
    isLoading,
    isError,
    ...
    updateCaptionAsync,
    deletePhotoAsync,
  } = useScoutingNotePhotos(scoutingNoteId)

  const onDrop = useCallback(
    (acceptedFiles: File[]) => {
      if (!scoutingNoteId) return
