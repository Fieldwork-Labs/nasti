...
CREATE TYPE "public"."org_user_types" AS ENUM (
    'Owner',
    'Admin'
);


ALTER TYPE "public"."org_user_types" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_user_organisation_id"() RETURNS "uuid"
...
CREATE TABLE IF NOT EXISTS "public"."collection" (
    ...
    "species_id" "uuid",
    "species_uncertain" boolean DEFAULT false,
    "field_name" "text",
    ...
    "plants_sampled_estimate" numeric
);
...
CREATE TABLE IF NOT EXISTS "public"."collection_photo" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."collection_photo" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."org_user" (
    ...
    "role" "public"."org_user_types" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."trip_species" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "trip_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."trip_species" OWNER TO "postgres";


ALTER TABLE ONLY "public"."collection_photo"
    ADD CONSTRAINT "collection_photo_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."org_user"
    ADD CONSTRAINT "org_user_user_id_key" UNIQUE ("user_id");
...
ALTER TABLE ONLY "public"."trip_member"
    ADD CONSTRAINT "trip_member_trip_id_user_id_key" UNIQUE ("trip_id", "user_id");
...
ALTER TABLE ONLY "public"."trip_species"
    ADD CONSTRAINT "trip_species_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."trip_species"
    ADD CONSTRAINT "trip_species_trip_id_species_id_key" UNIQUE ("trip_id", "species_id");



ALTER TABLE ONLY "public"."collection"
    ADD CONSTRAINT "collection_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."organisation"("id");



ALTER TABLE ONLY "public"."collection"
    ADD CONSTRAINT "collection_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."collection_photo"
    ADD CONSTRAINT "collection_photo_collection_id_fkey" FOREIGN KEY ("collection_id") REFERENCES "public"."collection"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."collection"
    ADD CONSTRAINT "collection_species_id_fkey" FOREIGN KEY ("species_id") REFERENCES "public"."species"("id");



ALTER TABLE ONLY "public"."collection"
    ADD CONSTRAINT "collection_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "public"."trip"("id");



ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_organisation_id_fkey" FOREIGN KEY ("organisation_id") REFERENCES "public"."organisation"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."org_user"
    ADD CONSTRAINT "org_user_organisation_id_fkey" FOREIGN KEY ("organisation_id") REFERENCES "public"."organisation"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."org_user"
    ADD CONSTRAINT "org_user_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."organisation"
    ADD CONSTRAINT "organisation_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trip"
    ADD CONSTRAINT "trip_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."trip_member"
    ADD CONSTRAINT "trip_member_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trip"
    ADD CONSTRAINT "trip_organisation_id_fkey" FOREIGN KEY ("organisation_id") REFERENCES "public"."organisation"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trip_species"
    ADD CONSTRAINT "trip_species_species_id_fkey" FOREIGN KEY ("species_id") REFERENCES "public"."species"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trip_species"
    ADD CONSTRAINT "trip_species_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "public"."trip"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."collection_photo" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "collection_photo_rls" ON "public"."collection_photo" USING ((EXISTS ( SELECT 1
   FROM "public"."collection"
  WHERE (("collection"."id" = "collection_photo"."collection_id") AND ("collection"."company_id" = ( SELECT "org_user"."organisation_id"
           FROM "public"."org_user"
          WHERE ("org_user"."user_id" = "auth"."uid"()))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."collection"
  WHERE (("collection"."id" = "collection_photo"."collection_id") AND ("collection"."company_id" = ( SELECT "org_user"."organisation_id"
           FROM "public"."org_user"
...
CREATE POLICY "collection_rls" ON "public"."collection" USING (("company_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"())))) WITH CHECK (("company_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "invitation_rls" ON "public"."invitation" USING (("organisation_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"())))) WITH CHECK (("organisation_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "org_user_rls" ON "public"."org_user" USING ((("organisation_id" = "public"."get_user_organisation_id"()) OR ("user_id" = "auth"."uid"()))) WITH CHECK ((("organisation_id" = "public"."get_user_organisation_id"()) OR ("user_id" = "auth"."uid"())));
...
CREATE POLICY "organisation_rls" ON "public"."organisation" USING (("id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"())))) WITH CHECK (("id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "species_rls" ON "public"."species" USING (true) WITH CHECK (true);
...
CREATE POLICY "trip_member_rls" ON "public"."trip_member" USING ((EXISTS ( SELECT 1
   FROM "public"."trip"
  WHERE (("trip"."id" = "trip_member"."trip_id") AND ("trip"."organisation_id" = ( SELECT "org_user"."organisation_id"
           FROM "public"."org_user"
          WHERE ("org_user"."user_id" = "auth"."uid"()))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."trip"
  WHERE (("trip"."id" = "trip_member"."trip_id") AND ("trip"."organisation_id" = ( SELECT "org_user"."organisation_id"
...
CREATE POLICY "trip_rls" ON "public"."trip" USING (("organisation_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"())))) WITH CHECK (("organisation_id" = ( SELECT "org_user"."organisation_id"
   FROM "public"."org_user"
  WHERE ("org_user"."user_id" = "auth"."uid"()))));
...
ALTER TABLE "public"."trip_species" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "trip_species_rls" ON "public"."trip_species" USING ((EXISTS ( SELECT 1
   FROM "public"."trip"
  WHERE (("trip"."id" = "trip_species"."trip_id") AND ("trip"."organisation_id" = ( SELECT "org_user"."organisation_id"
           FROM "public"."org_user"
          WHERE ("org_user"."user_id" = "auth"."uid"()))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."trip"
  WHERE (("trip"."id" = "trip_species"."trip_id") AND ("trip"."organisation_id" = ( SELECT "org_user"."organisation_id"
...
GRANT ALL ON TABLE "public"."collection_photo" TO "anon";
GRANT ALL ON TABLE "public"."collection_photo" TO "authenticated";
GRANT ALL ON TABLE "public"."collection_photo" TO "service_role";
...
GRANT ALL ON TABLE "public"."org_user" TO "anon";
GRANT ALL ON TABLE "public"."org_user" TO "authenticated";
GRANT ALL ON TABLE "public"."org_user" TO "service_role";
...
GRANT ALL ON TABLE "public"."trip_species" TO "anon";
GRANT ALL ON TABLE "public"."trip_species" TO "authenticated";
GRANT ALL ON TABLE "public"."trip_species" TO "service_role";
